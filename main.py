...
st.image("https://github.com/richarles1/acti/raw/refs/heads/main/logo.jpg", use_container_width=True)
...
"<h3 style='text-align: center;' title='Pour utiliser ce service vous devez avoir 18 ans accompli.'>Vérifier votre identité</h3>", 
    ...
    def load_ocr_reader():
        ...
        # Force GPU=False and switch model_storage_directory to use dbnet18
