...
#st.image("C:/Users/Evens/Pictures/bon/C/sunset.jpg", use_container_width=True)

st.image("C:/Users/Evens/Pictures/bon/C/logo.jpg", use_container_width=True)
# Keeps container width but restricts the maximum height to 150px
#st.image("https://unsplash.com", use_container_width=True)
...
# --- STAGE 2: RECORD DOES NOT EXIST ---
    ...
    #st.set_page_config(page_title="Haitian ID Front/Back Reader", page_icon="🇭🇹", layout="wide")
    #st.title("🇭🇹 Complete Haitian ID Card Scanner")
    st.markdown(
"<h3 style='text-align: center;' title='Pour utiliser ce service vous devez avoir 18 ans accompli.'>Vérifier votre identité</h3>", 
    unsafe_allow_html=True
    ...
    def load_ocr_reader():
        # If deploying to a GPU-enabled server, set gpu=True
    ...
    if uploaded_file is not None:
        ...
        with col1:
            ...
            st.image(image, caption=f"Target ", use_container_width=True)
